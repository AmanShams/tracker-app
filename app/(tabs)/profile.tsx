...
const s = StyleSheet.create({
  ...
  profileTopSection: { paddingHorizontal: 16, marginTop: 15 },
  avatarRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 25 },
  avatarOuter: { width: 68, height: 68, borderRadius: 24, borderWidth: 1, borderColor: '#f8f8f8', padding: 1, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center', marginRight: 16 },
  avatarBox: { width: 62, height: 62, borderRadius: 22, justifyContent: 'center', alignItems: 'center' },
  avatarInitials: { fontFamily: 'Inter_700Bold', fontSize: 22, color: C.accent, letterSpacing: -1 },
  nameLines: { flex: 1 },
  profileName: { fontFamily: 'Inter_700Bold', fontSize: 24, color: '#111111', letterSpacing: -1 },
  pillWrapper: { flexDirection: 'row', marginTop: 4 },
  ...
  balanceBlockCompact: { marginBottom: 20 },
  balanceLabelSmall: { fontFamily: 'Inter_400Regular', fontSize: 16, color: '#8E8E93', letterSpacing: -0.8, marginBottom: -5 },
  balanceValueRow: { flexDirection: 'row', alignItems: 'baseline' },
  balanceInt: { fontFamily: 'Inter_700Bold', fontSize: 44, color: '#3A3A3A', letterSpacing: -2, lineHeight: 52 },
  balanceDecimal: { fontFamily: 'Inter_400Regular', fontSize: 22, color: '#9A9A9E', letterSpacing: -0.3, lineHeight: 52, marginLeft: 1 },
  balanceDec: { fontFamily: 'Inter_400Regular', fontSize: 22, color: '#9A9A9E', letterSpacing: -0.3, lineHeight: 52, marginLeft: 1 },

  tickerRow: { flexDirection: 'row', marginHorizontal: 16, marginBottom: 25 },
  tickerItem: { flex: 1 },
  tickerLabel: { fontFamily: 'Inter_400Regular', fontSize: 16, color: '#8E8E93', marginBottom: -2, letterSpacing: -1.2 },
  tickerValueLine: { flexDirection: 'row', alignItems: 'baseline' },
  tickerInt: { fontFamily: 'Inter_700Bold', fontSize: 32, color: '#111', letterSpacing: -1.5, lineHeight: 40 },
  tickerDec: { fontFamily: 'Inter_400Regular', fontSize: 16, color: '#9A9A9E', marginLeft: 1 },

  menuListContainer: { paddingHorizontal: 16 },
  menuRow: { flexDirection: 'row', alignItems: 'center', paddingVertical: 14 },
  menuIconWrapper: { width: 44, height: 44, borderRadius: 13, borderWidth: 1, borderColor: '#f8f8f8', padding: 1, marginRight: 12, backgroundColor: '#FFFFFF', alignItems: 'center', justifyContent: 'center' },
  menuIconBox: { width: 38, height: 38, borderRadius: 11, borderWidth: 1.3, borderColor: '#f0f0f0', justifyContent: 'center', alignItems: 'center' },
  menuTextSide: { flex: 1 },
  menuTitleText: { fontFamily: 'Inter_600SemiBold', fontSize: 15, color: '#111111', letterSpacing: -0.3 },
  menuSeparator: { height: StyleSheet.hairlineWidth, backgroundColor: C.separator, marginLeft: 44 + 12 },

  footerSection: { marginTop: 40, alignItems: 'center', paddingHorizontal: 16 },
  logoutBtn: { flexDirection: 'row', alignItems: 'center', gap: 8, paddingBottom: 12 },
